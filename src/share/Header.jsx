                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="mx-auto me-5 pe-5">
                            ...
                            <Nav> <Link className='text-decoration-none text-secondary mt-2' to='/blog'>Blog</Link> </Nav>
                              ...
                              <Button className='ms-4 me-4 btn text-decoration-none 'style={{background:"	darkmagenta"}}>Logout</Button> 
                                <Link to="/login">
                                    <Button className='btn text-decoration-none' style={{background:"	darkmagenta"}}>Login</Button>
                                </Link>
